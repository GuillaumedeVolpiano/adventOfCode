...
inputPath :: String
inputPath = "/adventOfCode/input/2025/day1.txt"

tests :: Stream IO Word8 -> [Benchmark]
tests input =
  [ bench "Part 1" $ whnf (S.fold (Day1.findPassword Day1.calc)) input
  , bench "Part 2" $ whnf (S.fold (Day1.findPassword Day1.betterCalc)) input]
